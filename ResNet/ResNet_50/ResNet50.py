...
MODEL_SAVE_PATH = r'/ResNet/ResNet_50/resnet50_brain.pth'
...
model = models.resnet50(weights=models.ResNet50_Weights.DEFAULT)  # ✅ metoda corectă
...
# -------------------------
# GRAD-CAM IMPLEMENTATION (corectată)
