...
MODEL_SAVE_PATH = r'C:\disi\ViT_L_32\vit_l32_brain.pth'
os.makedirs(os.path.dirname(MODEL_SAVE_PATH), exist_ok=True)

# -------------------------
# PARAMETERS
IMG_SIZE = 224
BATCH_SIZE = 4   # mic pentru a evita OOM
EPOCHS = 3
LEARNING_RATE = 1e-4
...
# -------------------------
# LOAD VIT-L/32 PRETRAINED
print("Loading ViT-L/32 model...")
