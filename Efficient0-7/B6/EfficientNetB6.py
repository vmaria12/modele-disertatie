...
MODEL_SAVE_PATH = r'/Models/Efficient0-7\B6'
os.makedirs(MODEL_SAVE_PATH, exist_ok=True)
MODEL_FILENAME = os.path.join(MODEL_SAVE_PATH, 'efficientnet_b6.h5')
...
base_model = EfficientNetB6(include_top=False, input_tensor=inputs, pooling='avg', weights='imagenet')
