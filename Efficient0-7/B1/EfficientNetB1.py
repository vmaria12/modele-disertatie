...
# -------------------------
# PATHS
data_dir = r'D:\Disertatie\Brain\demo\DataSet\archive'
train_dir = os.path.join(data_dir, 'Training')
val_dir   = os.path.join(data_dir, 'Testing')

MODEL_SAVE_PATH = r'/Models/Efficient0-7\B1'
os.makedirs(MODEL_SAVE_PATH, exist_ok=True)
MODEL_FILENAME = os.path.join(MODEL_SAVE_PATH, 'efficientnet_b1.h5')
...
base_model = EfficientNetV2B1(include_top=False, input_tensor=inputs, pooling='avg', weights='imagenet')
